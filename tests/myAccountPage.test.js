    ...
    let page,
     ...
     /* it('should verify that My Project page create new project button takes us to create or edit page', async () => {
        ...
        try {
            ...
            await page.waitForTimeout(2000);  
            //await myaccountpage.getProjectTitles();
           //await myaccountpage.printProjectTitles();
           // const list=  await page.$x(myaccountpage.projectTitles)   
           // const projectTitles = await myaccountpage.getProjectTitles();
          // const projectTitles= await (myaccountpage.projectTitles);
           //console.log("Project title is:"+projectTitles);
           const projectTitlesXPath = await myaccountpage.getProjectTitles();
           const projectTitles = await commonPage.get_list(projectTitlesXPath);
